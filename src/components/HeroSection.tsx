...
export const HeroSection = () => {
  return (
    <section className="flex flex-col-reverse md:flex-row-reverse overflow-x-hidden px-4 md:px-16 pt-12 pb-40 md:pb-40">
      <div className="w-full md:w-1/2 flex justify-center md:justify-end">
        <img src={HeroImage} width="733" height="482" alt="working illustration" className="block w-[125vw] md:w-full" />
      </div>

      <div className="w-full md:w-1/2 text-left py-12 flex flex-col items-start justify-center pr-0 md:pr-12">
        <h1 className="text-[2.9rem] md:text-[4rem] font-extrabold text-very-dark-violet mb-0 mt-0">More than just shorter links</h1>
